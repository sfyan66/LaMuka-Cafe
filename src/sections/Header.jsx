...
function Header() {
  ...
  return (
    <header className={`bg-black px-[25px] md:px-[5px] py-[10px]  fixed top-0 left-0 w-full backdrop-blur-md z-100 bg-black/30 shadow-xl ${active === "Intro" ? "md:py-[25px]" : "md:py-[15px]"} transition-all duration-500 ease-in-out`}>
      <motion.div 
      initial={{opacity:0}}
      animate={{opacity:1}}
      transition={{duration:1,delay:3.5}}>
        <nav className='md:max-w-7xl max-w-5xl flex justify-between items-center m-auto'>
          <div className='text-[min(5.5vw,32px)] tracking-[1.2px] text-white font-serif'>LaMuka.</div>
