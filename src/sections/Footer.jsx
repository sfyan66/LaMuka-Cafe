  ...
  return (
    <div className="flex gap-[12px] justify-center md:justify-start">
      ...
      <svg
        ...
        className="jam jam-whatsapp svgg"
      >
    ...
    <footer className="mx-auto md:max-w-7xl max-w-5xl py-[48px]">
      <div className="flex flex-col md:flex-row justify-between text-center md:text-start">
        <div className="pb-[50px] md:pb-0">
          <h2 className="text-white font-serif text-[min(10vw,48px)] md:text-[min(3.5vw,45px)]">
            LaMuka.
          </h2>
          <Svgs />
        </div>
        <div className="flex flex-col md:flex-row gap-[40px] justify-between md:w-[70%]">
          {infos.map((info) => (
            <div key={info.title}>
              <h3 className="text-[var(--button-second-bg)] md:text-[min(2.1vw,26px)] pb-[15px] font-bold">
                {info.title}
              </h3>
              <p className="text-[var(--text-third-c)] md:text-[min(1.7vw,21px)]">
                {info.text1}
                <br />
                {info.text2}
              </p>
      ...
      <div className='relative after:content-[" "] after:bg-[var(--text-main-c)] after:w-full after:h-[1px] after:absolute after:top-0 after:opacity-20 mt-[96px] pt-[24px] flex justify-between'>
        <div className="text-[var(--text-main-c)] md:text-[min(1.8vw,19px)] text-[min(2.8vw,16px)] whitespace-pre">
          ...
          <a
            href=""
            className="text-white hover:text-[var(--button-second-bg)] cursor-pointer  opacity-80 md:text-[min(2.3vw,22px)] text-[min(3.5vw,20px)] underline"
          >
            Sfyan
          </a>
        </div>
        <Link
          ...
          duration={2000}
          offset={-180}
          className="group rounded-full p-2 md:p-3 border-[2px] border-white hover:border-[var(--button-second-bg)] cursor-pointer opacity-80 -mt-2"
        >
          <svg
            className="fill-white group-hover:fill-[var(--button-second-bg)] size-3 md:size-4"
            height="16px"
            width="16px"
            version="1.1"
            id="Layer_1"
