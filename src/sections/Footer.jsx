...
const Svgs = () => {
  return (
    <div className='flex gap-[12px]'> 
      <svg width="30px" className='svgg' height="30px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg width="30px" height="30px" className='svgg' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg className='svgg' width="30px" height="30px" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
      ...
      <svg width="30px" height="30px" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" className="jam jam-whatsapp svgg">
...
const Footer = () => {
  ...
  const infos = [
    {
      title: 'Location'
      ,text1: '456 Elm Street'
      ,text2: 'Los Angeles, CA 90001'
    },
    {
      title: 'Contacts'
      ,text1: 'contact@lamuka.com'
      ,text2: '(324)965-695-9660'
    },
    {
      title: 'Opening Hours'
      ,text1: 'Weekdays 10:00am - 9:00pm'
      ,text2: 'Weekends 9:00am - 10:00pm'
    }
  ]
  return (
    <footer className='mx-auto md:max-w-7xl max-w-5xl py-[48px]'>
        ...
        <div className='flex flex-col md:flex-row justify-between w-[70%]'>
          {infos.map((info) => (
            <div>
              ...
              <p 
              className='text-[var(--text-third-c)] md:text-[min(1.7vw,21px)]'>
      ...
      <div className='relative after:content-[" "] after:bg-[var(--text-main-c)] after:w-full after:h-[1px] after:absolute after:top-0 after:opacity-20 mt-[96px] pt-[24px] flex justify-between'>
          <div className='text-[var(--text-main-c)] md:text-[min(1.8vw,19px)] text-[min(2.8vw,16px)] whitespace-pre'>
          ...
          duration={2000}
          offset={-180}
          className='group rounded-full p-[15px] border-[2px] border-white hover:border-[var(--button-second-bg)] cursor-pointer opacity-80'>
            <svg className='fill-white group-hover:fill-[var(--button-second-bg)]' height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 330 330">
